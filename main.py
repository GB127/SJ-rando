...
def getoptions():
    parser = argparse.ArgumentParser(description='Solar Jet Randomizer, Version 1.0, written by Niamek', epilog="If you want more details about the flas or mode, the README details everything.")
